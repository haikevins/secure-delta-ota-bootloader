# `update_scheduler` — Update Scheduler (Reserved)
...
The current gateway serializes one command through a queue of length 1 and one worker task. Fleet/device scheduling is intentionally outside the current implementation.
