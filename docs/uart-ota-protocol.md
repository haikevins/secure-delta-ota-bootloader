...
- The receiver does not persist every acknowledged DATA offset; recovery resumes from the last complete persisted sector checkpoint.
...
For `INSTALL (0x20)`, the application-side receiver then:
